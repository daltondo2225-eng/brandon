...
// Icon set — Claude-style: unified 24-unit grid, 1.8px rounded strokes, minimal.
const checkIcon = (<svg width="17" height="17" viewBox="0 0 24 24" fill="none"><path d="M5 12.5l4.5 4.5L19 7" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>);
const plusIcon = (<svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M12 5v14M5 12h14" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg>);
const closeIcon = (<svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M6 6l12 12M18 6L6 18" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg>);
const moreIcon = (<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><circle cx="5" cy="12" r="1.6" fill="currentColor"/><circle cx="12" cy="12" r="1.6" fill="currentColor"/><circle cx="19" cy="12" r="1.6" fill="currentColor"/></svg>);
const docIcon = (<svg width="17" height="17" viewBox="0 0 24 24" fill="none"><path d="M6 3.5h7.5L19 9v10.5a1.5 1.5 0 01-1.5 1.5h-11A1.5 1.5 0 015 19.5v-14A1.5 1.5 0 016 3.5z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round"/><path d="M13.5 3.5V9H19" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round"/></svg>);
const templateIcon = (<svg width="16" height="16" viewBox="0 0 24 24" fill="none"><circle cx="6.5" cy="6.5" r="1.9" fill="currentColor"/><circle cx="17.5" cy="6.5" r="1.9" fill="currentColor"/><circle cx="6.5" cy="17.5" r="1.9" fill="currentColor"/><circle cx="17.5" cy="17.5" r="1.9" fill="currentColor"/></svg>);
const fileIcon = (<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M6 3.5h7.5L19 9v10.5a1.5 1.5 0 01-1.5 1.5h-11A1.5 1.5 0 015 19.5v-14A1.5 1.5 0 016 3.5z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round"/><path d="M13.5 3.5V9H19" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round"/></svg>);
const trashIcon = (<svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M4.5 6.5h15M9 6.5V4.5a1.5 1.5 0 011.5-1.5h3A1.5 1.5 0 0115 4.5v2M6.5 6.5l.9 13a1.5 1.5 0 001.5 1.4h6.2a1.5 1.5 0 001.5-1.4l.9-13" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>);
const pencilIcon = (<svg width="17" height="17" viewBox="0 0 24 24" fill="none"><path d="M16.5 3.5l4 4L9 19l-5 1.2L5.2 15 16.5 3.5z" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/><path d="M14.5 5.5l4 4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg>);
const copyIcon = (<svg width="17" height="17" viewBox="0 0 24 24" fill="none"><rect x="8" y="8" width="12" height="13" rx="2.5" stroke="currentColor" strokeWidth="1.8"/><path d="M4.5 16V6A2.5 2.5 0 017 3.5h9" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg>);
const paperclipIcon = (<svg width="17" height="17" viewBox="0 0 24 24" fill="none"><path d="M17.5 10.5l-6.8 6.8a3 3 0 01-4.3-4.3l7.4-7.4a4.5 4.5 0 016.4 6.4L12 19.8" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>);
const playIcon = (<svg width="13" height="13" viewBox="0 0 24 24" fill="none"><path d="M6 4.5l13 7.5-13 7.5V4.5z" fill="currentColor"/></svg>);
const refreshIcon = (<svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M20 12a8 8 0 11-2.3-5.6M20 4v4.5h-4.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>);
const backIcon = (<svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M15 5l-7 7 7 7" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>);
const chevronDownIcon = (<svg width="12" height="12" viewBox="0 0 24 24" fill="none"><path d="M6 9l6 6 6-6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>);
const gearIcon = (<svg width="16" height="16" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="3.2" stroke="currentColor" strokeWidth="1.8"/><path d="M12 2.5v3M12 18.5v3M21.5 12h-3M5.5 12h-3M18.7 5.3l-2.1 2.1M7.4 16.6l-2.1 2.1M18.7 18.7l-2.1-2.1M7.4 7.4L5.3 5.3" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg>);
const chatIcon = (<svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M4 5.5h16a1.5 1.5 0 011.5 1.5v8a1.5 1.5 0 01-1.5 1.5h-9l-5 4v-4H4A1.5 1.5 0 012.5 15V7A1.5 1.5 0 014 5.5z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round"/></svg>);
const moonIcon = (<svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M20 13.5A8 8 0 119.5 3.2a6.5 6.5 0 0010.5 10.3z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round"/></svg>);
const sunIcon = (<svg width="16" height="16" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="4" stroke="currentColor" strokeWidth="1.8"/><path d="M12 2.5v2.5M12 19v2.5M2.5 12H5M19 12h2.5M5 5l1.8 1.8M17.2 17.2L19 19M19 5l-1.8 1.8M6.8 17.2L5 19" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg>);
const systemIcon = (<svg width="16" height="16" viewBox="0 0 24 24" fill="none"><rect x="3" y="4.5" width="18" height="12" rx="2" stroke="currentColor" strokeWidth="1.8"/><path d="M8.5 20.5h7M12 16.5v4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg>);
const sendIconUp = (<svg width="17" height="17" viewBox="0 0 24 24" fill="none"><path d="M12 19V5M6 11l6-6 6 6" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"/></svg>);
