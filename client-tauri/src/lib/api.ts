...
/** @deprecated use KeyStatus */
export type AnthropicKeyStatus = KeyStatus;

export async function getAnthropicKeyStatus(): Promise<KeyStatus> {
  const res = await fetch(`${await base()}/settings/anthropic`, { headers: await authHeaders() });
  return handle<KeyStatus>(res);
}

export async function setAnthropicKey(key: string | null): Promise<KeyStatus> {
...
export async function getOpenAIKeyStatus(): Promise<KeyStatus> {
  const res = await fetch(`${await base()}/settings/openai`, { headers: await authHeaders() });
  return handle<KeyStatus>(res);
}

export async function setOpenAIKey(key: string | null): Promise<KeyStatus> {
  const res = await fetch(`${await base()}/settings/openai`, {
    method: "PUT",
    headers: await jsonHeaders(),
...
export async function getGeminiKeyStatus(): Promise<KeyStatus> {
  const res = await fetch(`${await base()}/settings/gemini`, { headers: await authHeaders() });
  return handle<KeyStatus>(res);
}

export async function setGeminiKey(key: string | null): Promise<KeyStatus> {
  const res = await fetch(`${await base()}/settings/gemini`, {
    method: "PUT",
    headers: await jsonHeaders(),
...
export interface GlobalDefaults { defaultInterviewBrief: string; defaultVoiceSample: string; }
...
export async function setDefaults(input: Partial<GlobalDefaults>): Promise<GlobalDefaults> {
